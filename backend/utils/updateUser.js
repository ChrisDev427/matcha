...
async function updateUser(req, res){
	...
	try { 
		...
		if (req.body.sexualPreferences[0] || req.body.sexualPreferences[1])
			{
				if (req.body.sexualPreferences[0] && req.body.sexualPreferences[1])
					user.sexualPreferences = "None";
				else if (req.body.sexualPreferences[0])
					user.sexualPreferences = req.body.sexualPreferences[0];
				else if (req.body.sexualPreferences[1])
					user.sexualPreferences = req.body.sexualPreferences[1];
			}
			else
			{
				user.sexualPreferences = "None";
